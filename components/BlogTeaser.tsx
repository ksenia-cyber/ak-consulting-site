    ...
    <section id="blog" className="section bg-white">
      <div className="container-xl">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 gap-4">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-1.5 text-emerald-800 font-semibold hover:gap-2.5 transition-all"
          >
            Alle Beiträge
          ...
          {posts.map((p) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="font-heading font-bold text-lg text-slate-900 leading-snug group-hover:text-emerald-800 transition-colors">
                  {p.title}
                </h3>
